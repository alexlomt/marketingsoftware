...
// Removed Suspense and useSearchParams for debugging
import { useState } from 'react'; 
import { useRouter } from 'next/navigation';

export default function LoginPage() {
  const router = useRouter();
  // const searchParams = useSearchParams(); // Temporarily removed
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Temporarily redirecting straight to dashboard
      const fromPath = '/dashboard'; 
      // const fromPath = searchParams.get('from') || '/dashboard'; // Original logic commented out
